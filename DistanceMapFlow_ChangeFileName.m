...
frames = 50; %Number of frames in image sequence
...
for k = 1:frames
    ...
    S3='.tif';
    if k < 10
        SS1 = ['CNC Hydrophilic.lif_narrow not bidirectional_Crop001_t00' num2str(k) '_ch00'];
    elseif k < 100
        SS1 = ['CNC Hydrophilic.lif_narrow not bidirectional_Crop001_t0' num2str(k) '_ch00'];
    else
        SS1 = ['CNC Hydrophilic.lif_narrow not bidirectional_Crop001_t' num2str(k) '_ch00'];
    end
